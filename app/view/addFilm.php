...
<form action=".?p=addFilm" method="POST" enctype="multipart/form-data" accept-charset="UTF-8" id="addToDB">
  <div class="form-group">
	  ...
	  <span class="element">
		...
		<input class="form-control" type="text" id="titreOriginal" name="titreOriginal" placeholder="Titre original" <?=getHTMLElements('titreOriginal',$errors) //sert a recup l'ancienne valeur et l'erreur?> autofocus/>
	  </span>
	  <span class="element">
	    <label for="titreTraduit">Titre 2</label>
		<input class="form-control" type="text" id="titreTraduit" name="titreTraduit" placeholder="Titre traduit" <?=getHTMLElements('titreTraduit',$errors)?> />
	  </span>
	  <span class="element">
	    <label for="duree">Durée<span class="required">*</span></label>
		<input class="form-control" type="text" id="duree" name="duree" placeholder="Durée (minutes)" <?=getHTMLElements('duree',$errors)?> />
	  </span>
	  <span class="element">
	    <label for="dateSortieSuisse">Date de sortie<span class="required">*</span></label>
		<input class="form-control" type="date" id="dateSortieSuisse" name="dateSortieSuisse" placeholder="Date de sortie (yyyy-mm-dd)" <?=getHTMLElements('dateSortieSuisse',$errors)?>/>
	  </span>
	  <span class="element">
		<label for="description">Description<span class="required">*</span></label>
		<textarea id="description" class="form-control" name="description" placeholder="Description" rows="4" <?=getHTMLElements('description',$errors)?>><?=((isset($_POST['description']) AND !empty($_POST['description'])) ? htmlspecialchars($_POST['description']) : '')?></textarea>
	  </span>
	  <span class="element">
		<label for="accordParental">PEGI<span class="required">*</span></label>
		<input type="text" class="form-control" id="accordParental" name="accordParental" placeholder="Accord parental" <?=getHTMLElements('accordParental',$errors)?>/>
	  </span>
	  <span class="element">
		<label for="pochetteFile">Pochette</label>
		<input type="file" class="form-control" id="pochetteFile" name="pochetteFile" placeholder="URL de l'image" accept="image/*" <?=getHTMLElements('pochetteFile',$errors)?> />
	  </span>
	  <span class="element">
		<label for="bandeAnnonceURL">Vidéo</label>
		<input type="text" class="form-control" id="bandeAnnonceURL" name="bandeAnnonceURL" placeholder="URL de la vidéo" <?=getHTMLElements('bandeAnnonceURL',$errors)?> />
	  </span>
	  <hr>
	  <span class="element">
	    <h4>Genres: <span class="required">*</span><a href="#" class="insertItem" id="insertGenre">(Ajouter un genre)</a></h4>
		<select class="form-control" name="genre1" id="genre1" class="genres">
	  ...
	  <span class="element">
	    ...
	    <select class="form-control" name="langue1" id="langue1" class="langues">
		  <option value="NULL">-</option>
	  ...
	  <span class="element">
	    ...
	    <select class="form-control" name="saga1" id="saga1" class="sagas">
		  <option value="NULL">-</option>
	  ...
	  <span class="element">
	    ...
	    <select class="form-control" name="societe1" id="societe1" class="societes">
		  <option value="NULL">-</option>
	  ...
	  <span class="element">
		...
		<div class="block">
		  ...
		  <input class="prix" type="text"  id="prix1" name="prix1" placeholder="Prix" <?=getHTMLElements('prix1',$errors,'prix')?> /> CHF
		</div>
		<?php
